...
public class BluetoothLeService extends Service {
    ...
    //Read and Write charcterstics
    public final static UUID READ_UUID = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
    public final static UUID WRITE_UUID = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e");
    public final static UUID SERVICE_UUID = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");

    BluetoothGattCharacteristic mLightCharacteristic;
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                for (BluetoothGattService service : services) {
                    ...
                    if (service.getUuid().equals(SERVICE_UUID)) {
                        System.out.println("gap service dicovered" + SERVICE_UUID);
                        mLightCharacteristic = service.getCharacteristic(WRITE_UUID);
    ...
    public void ON_OFF_METHOD(String commmand) {
        if (mLightCharacteristic != null) {
            System.out.println("*******#########" + commmand);
            mLightCharacteristic.setValue(commmand);
            mBluetoothGatt.writeCharacteristic(mLightCharacteristic);
        }
    }
}

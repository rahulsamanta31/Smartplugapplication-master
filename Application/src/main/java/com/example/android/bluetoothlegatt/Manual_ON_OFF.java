...
public class Manual_ON_OFF extends Activity {
    ...
    Button btnOnOff;
    public static String operationName = "smpff";
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                if(status == 0) {
                    ...
                    if (operationName!=null && operationName.equalsIgnoreCase("smpoff")) {
                        operationName = "smpon";
                        btnOnOff.setBackgroundResource(R.drawable.on_off);
                        btnOnOff.setText("ON");
                    } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual__on__off);
        ...
        btnOnOff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (operationName!=null && operationName.equalsIgnoreCase("smpoff")) {
                    //    operationName = "smpon";
                    mBluetoothLeService.ON_OFF_METHOD("smpon");
                } else {
                    //    operationName = "smpoff";
                    mBluetoothLeService.ON_OFF_METHOD("smpoff");
                }
            }
        });
